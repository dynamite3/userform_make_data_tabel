    ...
    async function viewinfo(){
        ...
        try{
            ...
            newdata.forEach(element => {
                ...
                t.innerText="EDIT"
                t.style.margin="10px"
                t.setAttribute("onclick","edit("+element.id+")")
                z.style.border="solid black 1px"
                z.appendChild(t);
                y.appendChild(z);
    ...
    async function edit(id){
        ...
        var ed= await fetch ("https://60ebd681e9647b0017cdded3.mockapi.io/user/"+id)
        d=await ed.json()
        document.getElementById("name").value=d.name
        document.getElementById("email").value=d.email
        document.getElementById("dob").value=d.dob
        document.getElementById("phonum").value=d.pn
        val=d.id
        console.log(d)
        document.getElementById("update").removeAttribute("disabled");
        document.getElementById("update").setAttribute("onclick","uupdate("+val+")");


    }

    async function uupdate(val){
        d={}
        d.name=document.getElementById("name").value
        d.email=document.getElementById("email").value
        d.dob=document.getElementById("dob").value
        d.pn=document.getElementById("phonum").value
        var ud= await fetch ("https://60ebd681e9647b0017cdded3.mockapi.io/user/"+val,{
            method: "PUT",
